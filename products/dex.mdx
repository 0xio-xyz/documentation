...
<Steps>
  ...
  <Step title="Solver Records the Fill">
...
```
lock() → send OCT → fill() → attest() → [challenge window] → settle()
  │         │          │         │                                │
  │         │          │         │                                └── Solver gets ETH
  │         │          │         └── Oracle verifies the OCT payout
  │         │          └── Solver records the Octra tx hash on the escrow
  │         └── Solver pays OCT to the user first
