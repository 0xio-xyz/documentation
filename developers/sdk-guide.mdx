...
| `INVALID_AMOUNT` | Negative amount, or a number that can't be represented exactly in micro-OCT (6 decimals) — pass a string like `"0.300000"` for exact control |
...
import {
  ...
  // Address derivation
  deriveOctraAddress, // async: base64 Ed25519 pubkey → "oct…" address
