...
Starting in v2.4.1, the SDK automatically detects when your DApp is running inside **0xio Desktop** or **0xio App** and uses the appropriate bridge transport. No code changes are required.
...
console.log('SDK Version:', SDK_VERSION); // "2.4.1"
