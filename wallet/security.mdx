...
- **Confirm:** Password or biometric required (on mobile, sends to an address you have whitelisted skip this check; see [Whitelisted Addresses](/wallet/sending#whitelisted-addresses-mobile))
