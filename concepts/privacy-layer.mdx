...
<AccordionGroup>
  ...
  <Accordion title="0xbow Privacy Pools (ETH Deposits with Compliance)">
...
<AccordionGroup>
  ...
  <Accordion title="Is this legal?">
    Privacy is legal. Money laundering is not. The 0xio privacy layer includes selective disclosure (viewing keys shared with auditors) and relayer compliance, following models established by Railgun and Umbra. Users can prove transaction history to authorized parties without making it public. Unlike Tornado Cash, which had no compliance mechanism, the design prioritizes regulatory compatibility.
  </Accordion>
</AccordionGroup>
